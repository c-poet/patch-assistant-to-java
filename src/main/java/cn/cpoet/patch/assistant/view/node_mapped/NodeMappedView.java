...
public class NodeMappedView {
    ...
    private DialogPane createDialogPane(Dialog<Boolean> dialog, Stage stage) {
        ...
        ButtonType updateReadmeBT = new ButtonType("更新", ButtonBar.ButtonData.YES);
        ...
        updateReadmeBtn.addEventFilter(ActionEvent.ACTION, e -> {
            new NodeMappedUpdateView(textArea.getText(), patchRootNode).show(dialog);
            e.consume();
        });
    ...
    public void showDialog(Stage stage) {
        ...
        dialog.setDialogPane(createDialogPane(dialog, stage));
        dialog.showAndWait();
    }
}
