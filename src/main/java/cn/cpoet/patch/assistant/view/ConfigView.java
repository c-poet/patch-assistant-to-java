...
public class ConfigView {
    ...
    public Node build() {
        ...
        configBox.getChildren().add(generaConfigPane);
        ...
        dockerConfigBox.getChildren().add(hostConfig);
        ...
        dockerConfigBox.getChildren().add(usernameConfig);
        ...
        dockerConfigBox.getChildren().add(passwordConfig);
        ...
        dockerConfigBox.getChildren().add(workPathConfig);

        dockerConfigPane.setContent(dockerConfigBox);
        configBox.getChildren().add(dockerConfigPane);
        return configBox;
    }
